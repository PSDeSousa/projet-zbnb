...
fetch("../zenbnb.json")
    ...
    .then(function(data){
        let AnnounceParisContainer = document.getElementById("announce-paris");
        let rep = "../";
        for (i = 0; i < data.listings.length; i++){
            let divAnnounceParis = document.createElement("div");
            ...
            if (announce.city === "Paris"){
                divAnnounceParis.innerHTML = htmlAnnounce;
                AnnounceParisContainer.appendChild(divAnnounceParis);
            }
        }
    })