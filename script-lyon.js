...
.then(function(data){
    let AnnounceLyonContainer = document.getElementById("announce-lyon");
    let rep = "../";
    for (i = 0; i < data.listings.length; i++){
        let divAnnounceLyon = document.createElement("div");
        ...
        if (announce.city === "Lyon"){
            divAnnounceLyon.innerHTML = htmlAnnounce;
            AnnounceLyonContainer.appendChild(divAnnounceLyon);
         }
    }
    })